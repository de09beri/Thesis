...
\begin{tabular}{c|c}
	\hline 
	\textbf{Vial} & \textbf{Expected Activity (Bq)} \\ 
	\hline 
	V0 & 1.71 \\ 
	\hline 
	V1 & 9.10 \\ 
	...
	\hline 
\end{tabular} 
\caption{Expected \Ac activity in vials prepared for spiking the LiLS. }
\label{tab:SpikeExpA}
\end{table}

\todo{MAKE PLOTS FOR THESE VIALS}
...
livetime, dead time, efficiency, rate 
