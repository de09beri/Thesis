...
In order to reach stability neutrons have to transform into protons, a process only accomplished through $\beta$ decay. \todo{Add reference to nuclear chart figure}
...
\begin{figure}[t]
	...
	\caption{The $\bar{\nu_e}$ spectrum predicted by the summation method using the JEFF-3.1.1 database fission fragment yields and the ENDF/B-VII.1 decay library. \todo{Add citation}}
	\label{fig:spectrum}
\end{figure}
...
\todo{Highly edit this section, esp conversion method}
...
The IBD reaction energy threshold is 1.8 MeV and the cross section is relatively high, $\sim 63 \times 10^{-44} cm^2/fisson$ integrated over the entire reactor neutrino energy spectrum \todo{Add cite to 'Physics with reactor neutrinos'}, and can be written as
...
The IBD cross-section increases with energy, whereas the $\bar{\nu_{e}}$ spectrum decreases with energy creating a detected energy spectrum that peaks around 3.8 MeV \todo{?} and dies off after $\sim$8 MeV, as seen in Figure~\ref{fig:ibdspectrum}. 
