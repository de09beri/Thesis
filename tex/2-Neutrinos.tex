...
This was in stark contrast to the expected discrete spectra that had been observed in gamma and alpha emission, and suggested that the laws of conservation were broken during beta decay. 
...
Their idea was to place a detector near a generated flux of neutrinos, fill it with an ample number of protons, and observe the resulting positrons. 
...
This would create a neutrino flux  large enough to provide a sufficient signal to background ratio. 
...
If neutrinos have exactly zero mass and travel at the speed of light, then by definition their helicity, or handedness, is a permanent property. 
